    ...
    return (
        <article>
            ...
            <section ref={elementSection} hidden={true}>
            {
              ...
              oldData.sectionType == "ul" ? <List courseID={oldData.courseSelect} classID={oldData.classSelect} topicID={oldData.topicSelect} sectionID={oldData.sectionSelect} isOrdered={false} /> :
